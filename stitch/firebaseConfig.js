...
// Configuração do Firebase suportando injeção via variáveis de ambiente (React/Vite/Next.js)
// com fallback para as credenciais padrão do seu aplicativo
const firebaseConfig = {
  ...
  storageBucket: typeof process !== "undefined" && process.env.REACT_APP_FIREBASE_STORAGE_BUCKIE || "suportetecnico-825a7.firebasestorage.app",
